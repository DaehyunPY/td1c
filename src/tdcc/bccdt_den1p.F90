...
!##########################################################
!##########################################################
subroutine bccdt_den1p_1(sh1,sp2,i0)
...
!  i0 ( h1 p2 )_y + = +1 * y ( h1 p2 )_y 0
  ...
  do p2 = norb1+1,nact
     i0(h1,p2) = i0(h1,p2) + fact * &
          g1inp(h1,p2,spin_g1inp_1)
  end do
  end do
  !$omp end do
  !$omp end parallel
end subroutine bccdt_den1p_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_2(sp1,sh2,i0)
...
!  i0 ( p1 h2 )_yt + = +1 * Sum ( h3 p4 ) * y ( h3 p4 )_y * t ( p4 p1 h3 h2 )_t 0
  ...
  do sp4 = 1,2
     ...
     do h3 = 1,norb1
     do p4 = norb1+1,nact
        i0(p1,h2) = i0(p1,h2) + fact * &
             g1inp(h3,p4,spin_g1inp_1) * t2inp(p4,p1,h3,h2,spin_t2inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den1p_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_3(sp1,sp2,i0)
...
!  i0 ( p1 p2 )_yt + = +1/2 * Sum ( h3 h4 p5 ) * y ( h3 h4 p5 p2 )_y * t ( p5 p1 h3 h4 )_t 0
  ...
  do sp5 = 1,2
     ...
     do h4 = 1,norb1
     do p5 = norb1+1,nact
        i0(p1,p2) = i0(p1,p2) + fact * &
             g2inp(h3,h4,p5,p2,spin_g2inp_1) * t2inp(p5,p1,h3,h4,spin_t2inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den1p_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_4(sh1,sh2,i0)
...
!  i0 ( h1 h2 )_yt + = -1/2 * Sum ( h3 p4 p5 ) * y ( h3 h1 p4 p5 )_y * t ( p4 p5 h3 h2 )_t 0
  ...
  do sp5 = 1,2
     ...
     do p4 = norb1+1,nact
     do p5 = norb1+1,nact
        i0(h1,h2) = i0(h1,h2) + fact * &
             g2inp(h3,h1,p4,p5,spin_g2inp_1) * t2inp(p4,p5,h3,h2,spin_t2inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den1p_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_5(sp1,sh2,i0)
...
!  i0 ( p1 h2 )_yt + = +1/4 * Sum ( h3 h4 p5 p6 ) * y ( h3 h4 p5 p6 )_y * t ( p5 p6 p1 h3 h4 h2 )_t 0
  ...
  do sp6 = 1,2
     ...
     do p6 = norb1+1,nact
        i0(p1,h2) = i0(p1,h2) + fact * &
             g2inp(h3,h4,p5,p6,spin_g2inp_1) * t3inp(p5,p6,p1,h3,h4,h2,spin_t3inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den1p_5
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_6(sp1,sh2,i0)
...
!  i0 ( p1 h2 )_ytt + = -1/4 * Sum ( h3 p4 p5 ) * i1 ( h3 p4 p5 p1 )_yt * t ( p4 p5 h3 h2 )_t 1
  ...
  do sp5 = 1,2
     ...
     call bccdt_den1p_6_1(sh3,sp4,sp5,sp1,itm_hppp)
     ...
     do p5 = norb1+1,nact
        i0(p1,h2) = i0(p1,h2) + fact * &
             itm_hppp(h3,p4,p5,p1) * t2inp(p4,p5,h3,h2,spin_t2inp_2)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hppp)
end subroutine bccdt_den1p_6
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_6_1(sh3,sp4,sp5,sp1,i1)
...
!      i1 ( h3 p4 p5 p1 )_yt + = +1 * Sum ( h6 h7 p8 ) * y ( h3 h6 h7 p4 p5 p8 )_y * t ( p1 p8 h6 h7 )_t 0
  ...
  do sp8 = 1,2
     ...
     do h7 = 1,norb1
     do p8 = norb1+1,nact
        i1(h3,p4,p5,p1) = i1(h3,p4,p5,p1) + fact * &
             g3inp(h3,h6,h7,p4,p5,p8,spin_g3inp_1) * t2inp(p1,p8,h6,h7,spin_t2inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den1p_6_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_7(sp1,sp2,i0)
...
!  i0 ( p1 p2 )_yt + = +1/12 * Sum ( h3 h4 h5 p6 p7 ) * y ( h3 h4 h5 p6 p7 p2 )_y * t ( p6 p7 p1 h3 h4 h5 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:nact,1:nact)
  integer(c_int) :: p1,p2
  integer(c_int) :: h3,h4,h5,p6,p7,sh3,sh4,sh5,sp6,sp7
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
  ...
  do sp7 = 1,2
     ...
     do p7 = norb1+1,nact
        i0(p1,p2) = i0(p1,p2) + fact * &
             g3inp(h3,h4,h5,p6,p7,p2,spin_g3inp_1) * t3inp(p6,p7,p1,h3,h4,h5,spin_t3inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den1p_7
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den1p_8(sh1,sh2,i0)
...
!  i0 ( h1 h2 )_yt + = -1/12 * Sum ( h3 h4 p5 p6 p7 ) * y ( h3 h4 h1 p5 p6 p7 )_y * t ( p5 p6 p7 h3 h4 h2 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:nact,1:nact)
  integer(c_int) :: h1,h2
  integer(c_int) :: h3,h4,p5,p6,p7,sh3,sh4,sp5,sp6,sp7
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
  ...
  do sp7 = 1,2
     ...
     do p7 = norb1+1,nact
        i0(h1,h2) = i0(h1,h2) + fact * &
             g3inp(h3,h4,h1,p5,p6,p7,spin_g3inp_1) * t3inp(p5,p6,p7,h3,h4,h2,spin_t3inp_2)
     end do
     end do
     end do
     end do
