...
!         i2 ( h3 p5 )_f + = 1 * f ( h3 p5 )_f 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sp5
...
!         i2 ( h6 p1 )_vt + = 1 * Sum ( h8 p7 ) * t ( p7 h8 )_t * v ( h6 h8 p1 p7 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh6,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,(norb1+1):nact)
  integer(c_int) :: h6,p1
  integer(c_int) :: h8,p7,sh8,sp7
  integer(c_int) :: spin_t1inp
...
!         i2 ( h3 h9 h11 h14 )_v + = 1 * v ( h3 h9 h11 h14 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh9,sh11,sh14
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,1:norb1)
  integer(c_int) :: h3,h9,h11,h14
  integer(c_int) :: sdum
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_int2x
  complex(kind(0d0)),parameter :: fact = 1.0d+0 * runit
...
!         i2 ( h3 p7 )_f + = 1 * f ( h3 p7 )_f 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sp7
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,p7
  integer(c_int) :: sdum
  integer(c_int) :: spin_fock
...
!         i2 ( h3 h8 h11 p6 )_v + = 1 * v ( h3 h8 h11 p6 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh8,sh11,sp6
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h8,h11,p6
  integer(c_int) :: sdum
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_int2x
  complex(kind(0d0)),parameter :: fact = 1.0d+0 * runit
...
!         i2 ( h7 h8 h12 p1 )_v + = 1 * v ( h7 h8 h12 p1 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh7,sh8,sh12,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h7,h8,h12,p1
  integer(c_int) :: sdum
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_int2x
  complex(kind(0d0)),parameter :: fact = 1.0d+0 * runit
...
!         i2 ( h8 p11 h12 p1 )_vt + = -1 * Sum ( p5 ) * t ( p5 h12 )_t * v ( h8 p11 p1 p5 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh8,sp11,sh12,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,(norb1+1):nact,1:norb1,(norb1+1):nact)
  integer(c_int) :: h8,p11,h12,p1
  integer(c_int) :: p5,sp5
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h10 p13 h12 p1 )_vt + = 1 * Sum ( h8 p6 ) * t ( p6 p13 h8 h12 )_t * v ( h8 h10 p1 p6 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh10,sp13,sh12,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,(norb1+1):nact,1:norb1,(norb1+1):nact)
  integer(c_int) :: h10,p13,h12,p1
  integer(c_int) :: h8,p6,sh8,sp6
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_t2inp
...
! i0 ( h3 h4 p1 p2 )_ytv + = -1 * P( 2 ) * Sum ( h8 h6 p7 ) * i1 ( h3 h4 h8 h6 p1 p7 )_yt * v ( h6 p7 h8 p2 )_v 1
  ...
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: h8,h6,p7,sh8,sh6,sp7
...
!     i1 ( h3 h4 h8 h6 p1 p7 )_yt + = -1 * Sum ( p5 ) * t ( p5 h6 )_t * y ( h3 h4 h8 p1 p5 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh8,sh6,sp1,sp7
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h3,h4,h8,h6,p1,p7
  integer(c_int) :: p5,sp5
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h4 h13 p5 )_yt + = -1 * Sum ( p7 ) * t ( p7 h13 )_t * y ( h3 h4 p5 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh13,sp5
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h13,p5
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h4 h12 p9 )_yt + = 1 * Sum ( h7 p5 p6 ) * t ( p5 p6 h7 h12 )_t * y ( h3 h4 h7 p5 p6 p9 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh12,sp9
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h12,p9
  integer(c_int) :: h7,p5,p6,sh7,sp5,sp6
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
!         i2 ( h3 h8 h13 p1 )_yt + = 1 * Sum ( p7 ) * t ( p7 h13 )_t * y ( h3 h8 p1 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh8,sh13,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h8,h13,p1
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h7 h8 h13 p1 p5 )_yt + = -1 * Sum ( p9 ) * t ( p9 h13 )_t * y ( h3 h7 h8 p1 p5 p9 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh7,sh8,sh13,sp1,sp5
  complex(kind(0d0)),intent(inout) :: &
       i2(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h3,h7,h8,h13,p1,p5
  integer(c_int) :: p9,sp9
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
...
! i0 ( h3 h4 p1 p2 )_yttv + = 1/2 * P( 2 ) * Sum ( h9 h6 h8 ) * i1 ( h3 h4 h9 h6 h8 p1 )_ytt * v ( h6 h8 h9 p2 )_v 1
  ...
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: h9,h6,h8,sh9,sh6,sh8
...
!     i1 ( h3 h4 h9 h6 h8 p1 )_ytt + = 1 * Sum ( p5 ) * t ( p5 h6 )_t * i2 ( h3 h4 h9 h8 p1 p5 )_yt 1
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh9,sh6,sh8,sp1
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h9,h6,h8,p1
  integer(c_int) :: p5,sp5
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_itm_hhhhpp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h4 h9 h8 p1 p5 )_yt + = -1 * Sum ( p7 ) * t ( p7 h8 )_t * y ( h3 h4 h9 p1 p5 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh9,sh8,sp1,sp5
  complex(kind(0d0)),intent(inout) :: &
       i2(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h3,h4,h9,h8,p1,p5
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
...
! i0 ( h3 h4 p1 p2 )_yttv + = 1/2 * P( 2 ) * Sum ( p11 h8 h10 ) * i1 ( h3 h4 p11 h8 h10 p1 )_ytt * v ( h8 h10 p2 p11 )_v 2
  ...
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: p11,h8,h10,sp11,sh8,sh10
  integer(c_int) :: spin_itm_hhphhp
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_dummy3
  integer(c_int),external :: tdcc_spin_int2x
...
!     i1 ( h3 h4 p11 h8 h10 p1 )_ytt + = 1 * t ( p11 h10 )_t * i2 ( h3 h4 h8 p1 )_yt 1
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sp11,sh8,sh10,sp1
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,(norb1+1):nact,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,p11,h8,h10,p1
  integer(c_int) :: sdum
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_itm_hhhp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h4 h8 p1 )_yt + = 1 * Sum ( h7 p5 p6 ) * t ( p5 p6 h7 h8 )_t * y ( h3 h4 h7 p1 p5 p6 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh8,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h8,p1
  integer(c_int) :: h7,p5,p6,sh7,sp5,sp6
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
!         i2 ( h3 h4 h6 h8 h10 p1 )_ytt + = 1 * Sum ( p7 ) * t ( p7 h8 )_t * i3 ( h3 h4 h6 h10 p1 p7 )_yt 1
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh6,sh8,sh10,sp1
  complex(kind(0d0)),intent(inout) :: &
       i2(1:norb1,1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h6,h8,h10,p1
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_itm_hhhhpp
  integer(c_int),external :: tdcc_spin_t1inp
...
!             i3 ( h3 h4 h6 h10 p1 p7 )_yt + = -1 * Sum ( p9 ) * t ( p9 h10 )_t * y ( h3 h4 h6 p1 p7 p9 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh6,sh10,sp1,sp7
  complex(kind(0d0)),intent(inout) :: &
       i3(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h3,h4,h6,h10,p1,p7
  integer(c_int) :: p9,sp9
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
