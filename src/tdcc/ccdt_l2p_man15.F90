!##########################################################
subroutine ccdt_l2p_man15(i0,work1,work2,work3)

!15: i0 ( i j a b )_ytv + = -1/2 * P( 4 ) * Sum ( c d ) * i1 ( i c a d )_yt * v ( j d b c )_v 1
  ...
  work1 = 0d0
  work2 = 0d0
  call ccdt_l2p_man15_1(work1,work2)
  ...
  do icc = 1,ncc2aa
     ...
     do d = norb1+1,nact
        i0(i,j,a,b,1) = i0(i,j,a,b,1) &
             + work1(i,c,a,d)*int2x(j,d,b,c,spin_int2aa) &
             + work2(i,c,a,d)*int2x(j,d,b,c,spin_int2ab) &
             - work1(j,c,a,d)*int2x(i,d,b,c,spin_int2aa) &
             - work2(j,c,a,d)*int2x(i,d,b,c,spin_int2ab) &
             - work1(i,c,b,d)*int2x(j,d,a,c,spin_int2aa) &
             - work2(i,c,b,d)*int2x(j,d,a,c,spin_int2ab) &
             + work1(j,c,b,d)*int2x(i,d,a,c,spin_int2aa) &
             + work2(j,c,b,d)*int2x(i,d,a,c,spin_int2ab)
     end do
     end do
  end do
  !$omp end do
  ...
  do icc = 1,ncc2ab
     ...
     do d = norb1+1,nact
        i0(i,j,a,b,2) = i0(i,j,a,b,2) &
             + work1(i,c,a,d)*int2x(j,d,b,c,spin_int2ab) &
             + work2(i,c,a,d)*int2x(j,d,b,c,spin_int2aa) &
             - work2(j,c,d,a)*int2x(i,d,c,b,spin_int2ab) &
             - work2(i,c,d,b)*int2x(d,j,a,c,spin_int2ab) &
             + work2(j,c,b,d)*int2x(i,d,a,c,spin_int2aa) &
             + work1(j,c,b,d)*int2x(i,d,a,c,spin_int2ab)
     end do
     end do
  end do
  !$omp end do
...
end subroutine ccdt_l2p_man15
!##########################################################
subroutine ccdt_l2p_man15_1(i1aa,i1ab)
...
end subroutine ccdt_l2p_man15_1
!##########################################################
