...
!##########################################################
!##########################################################
subroutine bccdt_l2p_1(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_v + = 1 * v ( h3 h4 p1 p2 )_v 0
  ...
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_2(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yf + = 1 * P( 4 ) * y ( h3 p1 )_y * f ( h4 p2 )_f 0
  ...
  call bccdt_l2p_2_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_2_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_2_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_2_perm(sh4,sh3,sp2,sp1,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_2_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sdum = 1,1
     ...
     do p2 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g1inp(h3,p1,spin_g1inp) * fock(h4,p2,spin_fock)
     end do
     end do
     end do
     end do
  ...
  end subroutine bccdt_l2p_2_perm
  !--------------------------------------------
end subroutine bccdt_l2p_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_3(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yv + = -1 * P( 2 ) * Sum ( h7 ) * y ( h7 p1 )_y * v ( h3 h4 h7 p2 )_v 0
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_3_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_3_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_3_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sh7 = 1,2
     ...
     do h7 = 1,norb1
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g1inp(h7,p1,spin_g1inp) * int2x(h3,h4,h7,p2,spin_int2x)
     end do
     end do
     end do
     end do
  ...
  end subroutine bccdt_l2p_3_perm
  !--------------------------------------------
end subroutine bccdt_l2p_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_4(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yv + = -1 * P( 2 ) * Sum ( p5 ) * y ( h3 p5 )_y * v ( h4 p5 p1 p2 )_v 0
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_4_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_4_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_4_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sp5 = 1,2
     ...
     do p5 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g1inp(h3,p5,spin_g1inp) * int2x(h4,p5,p1,p2,spin_int2x)
     end do
     end do
     end do
     end do
  ...
  end subroutine bccdt_l2p_4_perm
  !--------------------------------------------
end subroutine bccdt_l2p_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_5(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yf + = -1 * P( 2 ) * Sum ( h9 ) * y ( h3 h9 p1 p2 )_y * i1 ( h4 h9 )_f 2
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_5_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_5_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_5_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sh9 = 1,2
     ...
     call bccdt_l2p_5_1(sh4,sh9,itm_hh)
     call bccdt_l2p_5_2(sh4,sh9,itm_hh)
     ...
     do h9 = 1,norb1
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g2inp(h3,h9,p1,p2,spin_g2inp) * itm_hh(h4,h9)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hh)
  end subroutine bccdt_l2p_5_perm
  !--------------------------------------------
end subroutine bccdt_l2p_5
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_5_1(sh3,sh9,i1)
...
!     i1 ( h3 h9 )_f + = 1 * f ( h3 h9 )_f 0
  ...
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_5_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_5_2(sh3,sh9,i1)
...
!     i1 ( h3 h9 )_vt + = -1/2 * Sum ( h8 p5 p6 ) * t ( p5 p6 h8 h9 )_t * v ( h3 h8 p5 p6 )_v 0
  ...
  do sp6 = 1,2
     ...
     do p5 = norb1+1,nact
     do p6 = norb1+1,nact
        i1(h3,h9) = i1(h3,h9) + fact * &
             t2inp(p5,p6,h8,h9,spin_t2inp) * int2x(h3,h8,p5,p6,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_5_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_6(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yf + = 1 * P( 2 ) * Sum ( p10 ) * y ( h3 h4 p1 p10 )_y * i1 ( p10 p2 )_f 2
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_6_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_6_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_6_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sp10 = 1,2
     ...
     call bccdt_l2p_6_1(sp10,sp2,itm_pp)
     call bccdt_l2p_6_2(sp10,sp2,itm_pp)
     ...
     do p10 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g2inp(h3,h4,p1,p10,spin_g2inp) * itm_pp(p10,p2)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_pp)
  end subroutine bccdt_l2p_6_perm
  !--------------------------------------------
end subroutine bccdt_l2p_6
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_6_1(sp10,sp1,i1)
...
!     i1 ( p10 p1 )_f + = 1 * f ( p10 p1 )_f 0
  ...
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_6_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_6_2(sp10,sp1,i1)
...
!     i1 ( p10 p1 )_vt + = 1/2 * Sum ( h7 h8 p6 ) * t ( p6 p10 h7 h8 )_t * v ( h7 h8 p1 p6 )_v 0
  ...
  do sp6 = 1,2
     ...
     do h8 = 1,norb1
     do p6 = norb1+1,nact
        i1(p10,p1) = i1(p10,p1) + fact * &
             t2inp(p6,p10,h7,h8,spin_t2inp) * int2x(h7,h8,p1,p6,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_6_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_7(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yv + = 1/2 * Sum ( h9 h10 ) * y ( h9 h10 p1 p2 )_y * i1 ( h3 h4 h9 h10 )_v 2
  ...
  do sh10 = 1,2
     ...
     call bccdt_l2p_7_1(sh3,sh4,sh9,sh10,itm_hhhh)
     call bccdt_l2p_7_2(sh3,sh4,sh9,sh10,itm_hhhh)
     ...
     do h10 = 1,norb1
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g2inp(h9,h10,p1,p2,spin_g2inp) * itm_hhhh(h3,h4,h9,h10)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hhhh)
end subroutine bccdt_l2p_7
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_7_1(sh3,sh4,sh9,sh10,i1)
...
!     i1 ( h3 h4 h9 h10 )_v + = 1 * v ( h3 h4 h9 h10 )_v 0
  ...
  do h9 = 1,norb1
  do h10 = 1,norb1
     i1(h3,h4,h9,h10) = i1(h3,h4,h9,h10) + fact * &
          int2x(h3,h4,h9,h10,spin_int2x)
  end do
  end do
  end do
  end do
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_7_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_7_2(sh3,sh4,sh9,sh10,i1)
...
!     i1 ( h3 h4 h9 h10 )_vt + = 1/2 * Sum ( p5 p6 ) * t ( p5 p6 h9 h10 )_t * v ( h3 h4 p5 p6 )_v 0
  ...
  do sp6 = 1,2
     ...
     do p6 = norb1+1,nact
        i1(h3,h4,h9,h10) = i1(h3,h4,h9,h10) + fact * &
             t2inp(p5,p6,h9,h10,spin_t2inp) * int2x(h3,h4,p5,p6,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_7_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_8(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yv + = -1 * P( 4 ) * Sum ( h9 p7 ) * y ( h3 h9 p1 p7 )_y * i1 ( h4 p7 h9 p2 )_v 2
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_8_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_8_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_8_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_8_perm(sh4,sh3,sp2,sp1,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_8_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sp7 = 1,2
     ...
     call bccdt_l2p_8_1(sh4,sp7,sh9,sp2,itm_hphp)
     call bccdt_l2p_8_2(sh4,sp7,sh9,sp2,itm_hphp)
     ...
     do p7 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g2inp(h3,h9,p1,p7,spin_g2inp) * itm_hphp(h4,p7,h9,p2)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hphp)
  end subroutine bccdt_l2p_8_perm
  !--------------------------------------------
end subroutine bccdt_l2p_8
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_8_1(sh3,sp7,sh9,sp1,i1)
...
!     i1 ( h3 p7 h9 p1 )_v + = 1 * v ( h3 p7 h9 p1 )_v 0
  ...
  do h9 = 1,norb1
  do p1 = norb1+1,nact
     i1(h3,p7,h9,p1) = i1(h3,p7,h9,p1) + fact * &
          int2x(h3,p7,h9,p1,spin_int2x)
  end do
  end do
  end do
  end do
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_8_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_8_2(sh3,sp7,sh9,sp1,i1)
...
!     i1 ( h3 p7 h9 p1 )_vt + = -1 * Sum ( h8 p6 ) * t ( p6 p7 h8 h9 )_t * v ( h3 h8 p1 p6 )_v 0
  ...
  do sp6 = 1,2
     ...
     do p6 = norb1+1,nact
        i1(h3,p7,h9,p1) = i1(h3,p7,h9,p1) + fact * &
             t2inp(p6,p7,h8,h9,spin_t2inp) * int2x(h3,h8,p1,p6,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_8_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_9(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_yv + = 1/2 * Sum ( p5 p6 ) * y ( h3 h4 p5 p6 )_y * v ( p5 p6 p1 p2 )_v 0
  ...
  do sp6 = 1,2
     ...
     do p6 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g2inp(h3,h4,p5,p6,spin_g2inp) * int2x(p5,p6,p1,p2,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_9
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_10(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_yv + = 1/2 * P( 2 ) * Sum ( h14 h11 p13 ) * y ( h3 h11 h14 p1 p2 p13 )_y * i1 ( h4 p13 h11 h14 )_v 5
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_10_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_10_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_10_perm(sh3,sh4,sp1,sp2,i0)
  ...
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: h14,h11,p13,sh14,sh11,sp13
  ...
  do sp13 = 1,2
     ...
     call bccdt_l2p_10_1(sh4,sp13,sh11,sh14,itm_hphh)
     call bccdt_l2p_10_2(sh4,sp13,sh11,sh14,itm_hphh)
     call bccdt_l2p_10_3(sh4,sp13,sh11,sh14,itm_hphh)
     call bccdt_l2p_10_4(sh4,sp13,sh11,sh14,itm_hphh)
     call bccdt_l2p_10_5(sh4,sp13,sh11,sh14,itm_hphh)
     ...
     do p13 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             g3inp(h3,h11,h14,p1,p2,p13,spin_g3inp) * itm_hphh(h4,p13,h11,h14)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hphh)
  end subroutine bccdt_l2p_10_perm
  !--------------------------------------------
end subroutine bccdt_l2p_10
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_10_1(sh3,sp13,sh11,sh14,i1)
...
!     i1 ( h3 p13 h11 h14 )_v + = -1 * v ( h3 p13 h11 h14 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sp13,sh11,sh14
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,1:norb1,1:norb1)
  integer(c_int) :: h3,p13,h11,h14
  integer(c_int) :: sdum
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_int2x
  complex(kind(0d0)),parameter :: fact = -1.0d+0 * runit
  ...
  do h14 = 1,norb1
     i1(h3,p13,h11,h14) = i1(h3,p13,h11,h14) + fact * &
          int2x(h3,p13,h11,h14,spin_int2x)
  end do
  end do
  end do
  end do
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_10_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_10_2(sh3,sp13,sh11,sh14,i1)

!     i1 ( h3 p13 h11 h14 )_ft + = -1 * Sum ( p7 ) * t ( p7 p13 h11 h14 )_t * f ( h3 p7 )_f 0
  ...
  do sp7 = 1,2
     ...
     do p7 = norb1+1,nact
        i1(h3,p13,h11,h14) = i1(h3,p13,h11,h14) + fact * &
             t2inp(p7,p13,h11,h14,spin_t2inp) * fock(h3,p7,spin_fock)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_10_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_10_3(sh3,sp13,sh11,sh14,i1)

!     i1 ( h3 p13 h11 h14 )_vt + = -2 * Sum ( h8 p6 ) * t ( p6 p13 h8 h14 )_t * v ( h3 h8 h11 p6 )_v 0
  ...
  do sp6 = 1,2
     ...
     do p6 = norb1+1,nact
        i1(h3,p13,h11,h14) = i1(h3,p13,h11,h14) + fact * &
             t2inp(p6,p13,h8,h14,spin_t2inp) * int2x(h3,h8,h11,p6,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_10_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_10_4(sh3,sp13,sh11,sh14,i1)
...
end subroutine bccdt_l2p_10_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_10_5(sh3,sp13,sh11,sh14,i1)
...
end subroutine bccdt_l2p_10_5
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_11(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_yv + = 1/2 * P( 2 ) * Sum ( h12 p13 p11 ) * y ( h3 h4 h12 p1 p11 p13 )_y * i1 ( p11 p13 h12 p2 )_v 4
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_11_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_11_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_11_perm(sh3,sh4,sp1,sp2,i0)
  ...
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: h12,p13,p11,sh12,sp13,sp11
  integer(c_int) :: spin_g3inp
  ...
  do sp11 = 1,2
     ...
     call bccdt_l2p_11_1(sp11,sp13,sh12,sp2,itm_pphp)
     call bccdt_l2p_11_2(sp11,sp13,sh12,sp2,itm_pphp)
     call bccdt_l2p_11_3(sp11,sp13,sh12,sp2,itm_pphp)
     call bccdt_l2p_11_4(sp11,sp13,sh12,sp2,itm_pphp)
  ...
  deallocate(itm_pphp)
  end subroutine bccdt_l2p_11_perm
  !--------------------------------------------
end subroutine bccdt_l2p_11
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_11_1(sp11,sp13,sh12,sp1,i1)
...
!     i1 ( p11 p13 h12 p1 )_v + = -1 * v ( p11 p13 h12 p1 )_v 0
  ...
  do p1 = norb1+1,nact
     i1(p11,p13,h12,p1) = i1(p11,p13,h12,p1) + fact * &
          int2x(p11,p13,h12,p1,spin_int2x)
  end do
  end do
  end do
  end do
  !$omp end do
  !$omp end parallel
end subroutine bccdt_l2p_11_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_11_2(sp11,sp13,sh12,sp1,i1)

!     i1 ( p11 p13 h12 p1 )_vt + = -1/2 * Sum ( h7 h8 ) * t ( p11 p13 h7 h8 )_t * v ( h7 h8 h12 p1 )_v 0
  ...
  do sh8 = 1,2
     ...
     do h8 = 1,norb1
        i1(p11,p13,h12,p1) = i1(p11,p13,h12,p1) + fact * &
             t2inp(p11,p13,h7,h8,spin_t2inp) * int2x(h7,h8,h12,p1,spin_int2x)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_11_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_11_3(sp11,sp13,sh12,sp1,i1)
...
end subroutine bccdt_l2p_11_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_11_4(sp11,sp13,sh12,sp1,i1)
...
end subroutine bccdt_l2p_11_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_12(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_ytv + = 1 * P( 2 ) * Sum ( h11 ) * i1 ( h3 h11 )_yt * v ( h4 h11 p1 p2 )_v 2
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_12_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_12_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_12_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sh11 = 1,2
     ...
     itm_hh(1:norb1,1:norb1) = czero
     call bccdt_l2p_12_1(sh3,sh11,itm_hh)
     call bccdt_l2p_12_2(sh3,sh11,itm_hh)
  ...
  deallocate(itm_hh)
  end subroutine bccdt_l2p_12_perm
  !--------------------------------------------
end subroutine bccdt_l2p_12
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_12_1(sh3,sh11,i1)
...
end subroutine bccdt_l2p_12_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_12_2(sh3,sh11,i1)
...
end subroutine bccdt_l2p_12_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_13(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_ytf + = 1 * P( 2 ) * Sum ( h5 ) * i1 ( h3 h4 h5 p1 )_yt * f ( h5 p2 )_f 1
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_13_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_13_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_13_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sh5 = 1,2
     ...
     call bccdt_l2p_13_1(sh3,sh4,sh5,sp1,itm_hhhp)
  ...
  deallocate(itm_hhhp)
  end subroutine bccdt_l2p_13_perm
  !--------------------------------------------
end subroutine bccdt_l2p_13
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_13_1(sh3,sh4,sh5,sp1,i1)
...
end subroutine bccdt_l2p_13_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_14(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_ytv + = 1 * P( 4 ) * Sum ( h8 h10 ) * i1 ( h3 h8 h10 p1 )_yt * v ( h4 h10 h8 p2 )_v 1
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_14_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_14_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_14_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_14_perm(sh4,sh3,sp2,sp1,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_14_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sh10 = 1,2
     ...
     itm_hhhp(1:norb1,1:norb1,1:norb1,(norb1+1):nact) = czero
     call bccdt_l2p_14_1(sh3,sh8,sh10,sp1,itm_hhhp)
  ...
  deallocate(itm_hhhp)
  end subroutine bccdt_l2p_14_perm
  !--------------------------------------------
end subroutine bccdt_l2p_14
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_14_1(sh3,sh8,sh10,sp1,i1)
...
!     i1 ( h3 h8 h10 p1 )_yt + = 1/2 * Sum ( h7 p5 p6 ) * t ( p5 p6 h7 h10 )_t * y ( h3 h7 h8 p1 p5 p6 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh8,sh10,sp1
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h8,h10,p1
  integer(c_int) :: h7,p5,p6,sh7,sp5,sp6
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
end subroutine bccdt_l2p_14_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_15(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_ytv + = 1 * Sum ( h10 p8 ) * i1 ( h3 h4 h10 p8 )_yt * v ( h10 p8 p1 p2 )_v 1
  ...
  do sp8 = 1,2
     ...
     itm_hhhp(1:norb1,1:norb1,1:norb1,(norb1+1):nact) = czero
     call bccdt_l2p_15_1(sh3,sh4,sh10,sp8,itm_hhhp)
     ...
     do p8 = norb1+1,nact
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             itm_hhhp(h3,h4,h10,p8) * int2x(h10,p8,p1,p2,spin_int2x)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hhhp)
end subroutine bccdt_l2p_15
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_15_1(sh3,sh4,sh10,sp8,i1)
...
!     i1 ( h3 h4 h10 p8 )_yt + = -1/2 * Sum ( h7 p5 p6 ) * t ( p5 p6 h7 h10 )_t * y ( h3 h4 h7 p5 p6 p8 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh10,sp8
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h10,p8
  integer(c_int) :: h7,p5,p6,sh7,sp5,sp6
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
end subroutine bccdt_l2p_15_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_16(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_ytv + = 1/2 * P( 2 ) * Sum ( p11 ) * i1 ( p11 p1 )_yt * v ( h3 h4 p2 p11 )_v 2
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_16_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_16_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_16_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sp11 = 1,2
     ...
     itm_pp((norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_16_1(sp11,sp1,itm_pp)
     call bccdt_l2p_16_2(sp11,sp1,itm_pp)
  ...
  deallocate(itm_pp)
  end subroutine bccdt_l2p_16_perm
  !--------------------------------------------
end subroutine bccdt_l2p_16
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_16_1(sp11,sp1,i1)
...
end subroutine bccdt_l2p_16_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_16_2(sp11,sp1,i1)
...
end subroutine bccdt_l2p_16_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_17(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_ytv + = 1/4 * Sum ( h12 h13 ) * i1 ( h3 h4 h12 h13 )_yt * v ( h12 h13 p1 p2 )_v 2
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: h12,h13,sh12,sh13
  integer(c_int) :: spin_itm_hhhh
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_dummy2
  integer(c_int),external :: tdcc_spin_int2x
  ...
  do sh13 = 1,2
     ...
     itm_hhhh(1:norb1,1:norb1,1:norb1,1:norb1) = czero
     call bccdt_l2p_17_1(sh3,sh4,sh12,sh13,itm_hhhh)
     call bccdt_l2p_17_2(sh3,sh4,sh12,sh13,itm_hhhh)
     ...
     do h13 = 1,norb1
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             itm_hhhh(h3,h4,h12,h13) * int2x(h12,h13,p1,p2,spin_int2x)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hhhh)
end subroutine bccdt_l2p_17
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_17_1(sh3,sh4,sh12,sh13,i1)
...
!     i1 ( h3 h4 h12 h13 )_yt + = 1 * Sum ( p5 p6 ) * t ( p5 p6 h12 h13 )_t * y ( h3 h4 p5 p6 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh12,sh13
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,1:norb1,1:norb1)
  integer(c_int) :: h3,h4,h12,h13
  integer(c_int) :: p5,p6,sp5,sp6
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t2inp
  ...
  do sp6 = 1,2
     ...
     do p6 = norb1+1,nact
        i1(h3,h4,h12,h13) = i1(h3,h4,h12,h13) + fact * &
             t2inp(p5,p6,h12,h13,spin_t2inp) * g2inp(h3,h4,p5,p6,spin_g2inp)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_l2p_17_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_17_2(sh3,sh4,sh12,sh13,i1)
...
end subroutine bccdt_l2p_17_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_18(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_ytv + = -1/2 * Sum ( h9 p6 ) * i1 ( h9 p6 p1 p2 )_yt * v ( h3 h4 h9 p6 )_v 1
  ...
  do sp6 = 1,2
     ...
     call bccdt_l2p_18_1(sh9,sp6,sp1,sp2,itm_hppp)
  ...
  deallocate(itm_hppp)
end subroutine bccdt_l2p_18
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_18_1(sh9,sp6,sp1,sp2,i1)
...
end subroutine bccdt_l2p_18_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_19(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_ytv + = -1/2 * P( 4 ) * Sum ( p6 p9 ) * i1 ( h3 p6 p1 p9 )_yt * v ( h4 p9 p2 p6 )_v 1
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_19_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_19_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_19_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_19_perm(sh4,sh3,sp2,sp1,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_19_perm(sh3,sh4,sp1,sp2,i0)
  ...
  do sp9 = 1,2
     ...
     itm_hppp(1:norb1,(norb1+1):nact,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_19_1(sh3,sp6,sp1,sp9,itm_hppp)
  ...
  deallocate(itm_hppp)
  end subroutine bccdt_l2p_19_perm
  !--------------------------------------------
end subroutine bccdt_l2p_19
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_19_1(sh3,sp6,sp1,sp9,i1)
...
end subroutine bccdt_l2p_19_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_20(sh3,sh4,sp1,sp2,i0)
...
! i0 ( h3 h4 p1 p2 )_vty + = 1/12 * Sum ( p6 p7 ) * i1 ( p6 p7 p1 p2 )_yt * v ( h3 h4 p6 p7 )_v 1
  ...
  do sp7 = 1,2
     ...
     call bccdt_l2p_20_1(sp6,sp7,sp1,sp2,itm_pppp)
  ...
  deallocate(itm_pppp)
end subroutine bccdt_l2p_20
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_20_1(sp6,sp7,sp1,sp2,i1)
...
end subroutine bccdt_l2p_20_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_21(sh3,sh4,sp1,sp2,i0)

! i0 ( h3 h4 p1 p2 )_ytv + = 1/4 * P( 4 ) * Sum ( p12 h13 ) * i1 ( h3 p12 h13 p1 )_yt * v ( h4 h13 p2 p12 )_v 1
  ...
  i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
  call bccdt_l2p_21_perm(sh3,sh4,sp1,sp2,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h3 = 1,norb1
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_21_perm(sh4,sh3,sp1,sp2,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_21_perm(sh3,sh4,sp2,sp1,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sh3 * sh4 * sp1 * sp2 == 1)) then
     i0_perm(1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_l2p_21_perm(sh4,sh3,sp2,sp1,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_l2p_21_perm(sh3,sh4,sp1,sp2,i0)
  ...
  integer(c_int) :: h3,h4,p1,p2
  integer(c_int) :: p12,h13,sp12,sh13
  integer(c_int) :: spin_itm_hphp
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_dummy2
  integer(c_int),external :: tdcc_spin_int2x
  ...
  do sh13 = 1,2
     ...
     itm_hphp(1:norb1,(norb1+1):nact,1:norb1,(norb1+1):nact) = czero
     call bccdt_l2p_21_1(sh3,sp12,sh13,sp1,itm_hphp)
     ...
     do h13 = 1,norb1
        i0(h3,h4,p1,p2) = i0(h3,h4,p1,p2) + fact * &
             itm_hphp(h3,p12,h13,p1) * int2x(h4,h13,p2,p12,spin_int2x)
     end do
     end do
     end do
     end do
  ...
  deallocate(itm_hphp)
  end subroutine bccdt_l2p_21_perm
  !--------------------------------------------
end subroutine bccdt_l2p_21
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_l2p_21_1(sh3,sp12,sh13,sp1,i1)
...
!     i1 ( h3 p12 h13 p1 )_yt + = 1 * Sum ( h8 h9 p5 p6 ) * t ( p5 p6 p12 h8 h9 h13 )_t * y ( h3 h8 h9 p1 p5 p6 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sp12,sh13,sp1
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,p12,h13,p1
