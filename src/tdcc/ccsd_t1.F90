...
!##########################################################
!##########################################################
subroutine ccsd_t1_1(sp2,sh1,i0)
...
end subroutine ccsd_t1_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2(sp2,sh1,i0)
...
! i0 ( p2 h1 )_tf + = -1 * Sum ( h7 ) * t ( p2 h7 )_t * i1 ( h7 h1 )_f 4
  ...
  do sh7 = 1,2
     ...
     call ccsd_t1_2_1(sh7,sh1,itm_hh)
     call ccsd_t1_2_2(sh7,sh1,itm_hh)
     call ccsd_t1_2_3(sh7,sh1,itm_hh)
     call ccsd_t1_2_4(sh7,sh1,itm_hh)
  ...
  deallocate(itm_hh)
end subroutine ccsd_t1_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2_1(sh7,sh1,i1)
...
end subroutine ccsd_t1_2_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2_2(sh7,sh1,i1)
...
!     i1 ( h7 h1 )_ft + = 1 * Sum ( p8 ) * t ( p8 h1 )_t * i2 ( h7 p8 )_f 2
  ...
  do sp8 = 1,2
     ...
     call ccsd_t1_2_2_1(sh7,sp8,itm_hp)
     call ccsd_t1_2_2_2(sh7,sp8,itm_hp)
  ...
  deallocate(itm_hp)
end subroutine ccsd_t1_2_2
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2_2_1(sh7,sp8,i2)
...
end subroutine ccsd_t1_2_2_1
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2_2_2(sh7,sp8,i2)
...
end subroutine ccsd_t1_2_2_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2_3(sh7,sh1,i1)
...
end subroutine ccsd_t1_2_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_2_4(sh7,sh1,i1)
...
end subroutine ccsd_t1_2_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_3(sp2,sh1,i0)
...
! i0 ( p2 h1 )_tf + = 1 * Sum ( p3 ) * t ( p3 h1 )_t * i1 ( p2 p3 )_f 2
  ...
  do sp3 = 1,2
     ...
     call ccsd_t1_3_1(sp2,sp3,itm_pp)
     call ccsd_t1_3_2(sp2,sp3,itm_pp)
  ...
  deallocate(itm_pp)
end subroutine ccsd_t1_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_3_1(sp2,sp3,i1)
...
end subroutine ccsd_t1_3_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_3_2(sp2,sp3,i1)
...
end subroutine ccsd_t1_3_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_4(sp2,sh1,i0)
...
end subroutine ccsd_t1_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_5(sp2,sh1,i0)
...
! i0 ( p2 h1 )_tf + = 1 * Sum ( p7 h8 ) * t ( p2 p7 h1 h8 )_t * i1 ( h8 p7 )_f 2
  ...
  do sh8 = 1,2
     ...
     itm_hp(1:norb1,(norb1+1):nact) = czero
     call ccsd_t1_5_1(sh8,sp7,itm_hp)
     call ccsd_t1_5_2(sh8,sp7,itm_hp)
  ...
  deallocate(itm_hp)
end subroutine ccsd_t1_5
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_5_1(sh8,sp7,i1)
...
end subroutine ccsd_t1_5_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_5_2(sh8,sp7,i1)
...
end subroutine ccsd_t1_5_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_6(sp2,sh1,i0)
...
! i0 ( p2 h1 )_vt + = -1/2 * Sum ( h4 h5 p3 ) * t ( p2 p3 h4 h5 )_t * i1 ( h4 h5 h1 p3 )_v 2
  ...
  do sp3 = 1,2
     ...
     call ccsd_t1_6_1(sh4,sh5,sh1,sp3,itm_hhhp)
     call ccsd_t1_6_2(sh4,sh5,sh1,sp3,itm_hhhp)
  ...
  deallocate(itm_hhhp)
end subroutine ccsd_t1_6
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_6_1(sh4,sh5,sh1,sp3,i1)
...
!     i1 ( h4 h5 h1 p3 )_v + = 1 * v ( h4 h5 h1 p3 )_v 0
  ...
  implicit none
  integer,intent(in) :: sh4,sh5,sh1,sp3
...
end subroutine ccsd_t1_6_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_6_2(sh4,sh5,sh1,sp3,i1)
...
end subroutine ccsd_t1_6_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccsd_t1_7(sp2,sh1,i0)
...
end subroutine ccsd_t1_7
!##########################################################
!##########################################################
!##########################################################
!**********************************************************
subroutine ccsd_t1_main()
  ...
  call ccsd_t1_1(1,1,t1out(norb1+1,1,1))
  call ccsd_t1_2(1,1,t1out(norb1+1,1,1))
  call ccsd_t1_3(1,1,t1out(norb1+1,1,1))
  call ccsd_t1_4(1,1,t1out(norb1+1,1,1))
  call ccsd_t1_5(1,1,t1out(norb1+1,1,1))
  call ccsd_t1_6(1,1,t1out(norb1+1,1,1))
  call ccsd_t1_7(1,1,t1out(norb1+1,1,1))
  t1out(:,:,2) = t1out(:,:,1)

end subroutine ccsd_t1_main
!**********************************************************
