...
!##########################################################
!##########################################################
subroutine ccdt_bmat2p_1(sh1,sp2,i0)
...
end subroutine ccdt_bmat2p_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccdt_bmat2p_2(sh1,sp2,i0)
...
!  i0 ( h1 p2 )_ydtt + = -1/4 * Sum ( h3 h4 p5 ) * i1 ( h3 h4 p5 h1 )_ydt * t ( p2 p5 h3 h4 )_t 1
  ...
  do sp5 = 1,2
     ...
     call ccdt_bmat2p_2_1(sh3,sh4,sp5,sh1,itm_hhph)
  ...
  deallocate(itm_hhph)
end subroutine ccdt_bmat2p_2
!##########################################################
!##########################################################
!##########################################################
subroutine ccdt_bmat2p_2_1(sh3,sh4,sp5,sh1,i1)
...
end subroutine ccdt_bmat2p_2_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine ccdt_bmat2p_3(sh1,sp2,i0)
...
!  i0 ( h1 p2 )_ytdt + = -1/4 * Sum ( h3 h4 p5 ) * i1 ( h3 h4 p5 h1 )_yt * dt ( p5 p2 h3 h4 )_dt 1
  ...
  do sp5 = 1,2
     ...
     itm_hhph(1:norb1,1:norb1,(norb1+1):nact,1:norb1) = czero
     call ccdt_bmat2p_3_1(sh3,sh4,sp5,sh1,itm_hhph)
  ...
  deallocate(itm_hhph)
end subroutine ccdt_bmat2p_3
!##########################################################
!##########################################################
!##########################################################
subroutine ccdt_bmat2p_3_1(sh3,sh4,sp5,sh1,i1)
...
end subroutine ccdt_bmat2p_3_1
!##########################################################
!##########################################################
!##########################################################
