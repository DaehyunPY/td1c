!##########################################################
subroutine ccdt_l3p_man01(i0,work1,work2,work3)
...
!     i0(i,j,k,a,b,c,2) = i0(i,j,k,a,b,c,2) &
!          + g2inp(i,j,a,b,1)*fock(k,c,spin_focka) &
!          + g2inp(k,j,c,b,3)*fock(i,a,spin_focka) &
!          - g2inp(j,k,a,c,3)*fock(i,b,spin_focka) &
!          - g2inp(i,k,b,c,3)*fock(j,a,spin_focka) &
!          + g2inp(i,k,a,c,3)*fock(j,b,spin_focka)
  end do
  !$omp end do
  !$omp end parallel
