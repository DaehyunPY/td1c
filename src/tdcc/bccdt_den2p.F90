...
!##########################################################
!##########################################################
subroutine bccdt_den2p_1(sp1,sp2,sp3,sp4,i0)
...
end subroutine bccdt_den2p_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_2(sh1,sh2,sh3,sh4,i0)
...
end subroutine bccdt_den2p_2
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_3(sp1,sp2,sp3,sh4,i0)
...
end subroutine bccdt_den2p_3
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_4(sh1,sp2,sh3,sh4,i0)
...
end subroutine bccdt_den2p_4
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_5(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_t + = +1 * t ( p1 p2 h3 h4 )_t 0
  ...
  !$omp end do
  !$omp end parallel
end subroutine bccdt_den2p_5
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_6(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = +1/2 * P( h3 h4 ) * P( p1 p2 ) * Sum ( h5 p6 ) * i1 ( h5 p6 p1 h3 )_yt * t ( p2 p6 h4 h5 )_t 1
  ...
  call bccdt_den2p_6_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_6_perm(sp1,sp2,sh4,sh3,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_6_perm(sp2,sp1,sh3,sh4,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_6_perm(sp2,sp1,sh4,sh3,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_6_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sp6 = 1,2
     ...
     call bccdt_den2p_6_1(sh5,sp6,sp1,sh3,itm_hpph)
  ...
  deallocate(itm_hpph)
  end subroutine bccdt_den2p_6_perm
  !--------------------------------------------
end subroutine bccdt_den2p_6
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_6_1(sh5,sp6,sp1,sh3,i1)
...
end subroutine bccdt_den2p_6_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_7(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = -1/2 * P( h3 h4 ) * Sum ( h5 ) * i1 ( h5 h3 )_yt * t ( p1 p2 h5 h4 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_7_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_7_perm(sp1,sp2,sh4,sh3,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_7_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sh5 = 1,2
     ...
     call bccdt_den2p_7_1(sh5,sh3,itm_hh)
  ...
  deallocate(itm_hh)
  end subroutine bccdt_den2p_7_perm
  !--------------------------------------------
end subroutine bccdt_den2p_7
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_7_1(sh5,sh3,i1)
...
end subroutine bccdt_den2p_7_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_8(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = -1/2 * P( p1 p2 ) * Sum ( p5 ) * i1 ( p5 p1 )_yt * t ( p5 p2 h3 h4 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_8_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_8_perm(sp2,sp1,sh3,sh4,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_8_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sp5 = 1,2
     ...
     call bccdt_den2p_8_1(sp5,sp1,itm_pp)
  ...
  deallocate(itm_pp)
  end subroutine bccdt_den2p_8_perm
  !--------------------------------------------
end subroutine bccdt_den2p_8
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_8_1(sp5,sp1,i1)
...
end subroutine bccdt_den2p_8_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_9(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = +1/4 * Sum ( h5 h6 ) * i1 ( h5 h6 h3 h4 )_yt * t ( p1 p2 h5 h6 )_t 1
  ...
  do sh6 = 1,2
     ...
     call bccdt_den2p_9_1(sh5,sh6,sh3,sh4,itm_hhhh)
  ...
  deallocate(itm_hhhh)
end subroutine bccdt_den2p_9
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_9_1(sh5,sh6,sh3,sh4,i1)
...
end subroutine bccdt_den2p_9_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_10(sh1,sp2,sp3,sh4,i0)
...
end subroutine bccdt_den2p_10
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_11(sh1,sh2,sp3,sp4,i0)
...
!  i0 ( h1 h2 p3 p4 )_y + = +1 * y ( h1 h2 p3 p4 )_y 0
  ...
  !$omp end do
  !$omp end parallel
end subroutine bccdt_den2p_11
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_12(sp1,sp2,sp3,sp4,i0)
...
!  i0 ( p1 p2 p3 p4 )_yt + = +1/6 * Sum ( h5 h6 h7 p8 ) * y ( h5 h6 h7 p3 p4 p8 )_y * t ( p1 p2 p8 h5 h6 h7 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:nact,1:nact,1:nact,1:nact)
  integer(c_int) :: p1,p2,p3,p4
  integer(c_int) :: h5,h6,h7,p8,sh5,sh6,sh7,sp8
  integer(c_int) :: spin_g3inp_1
...
end subroutine bccdt_den2p_12
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_13(sh1,sh2,sh3,sh4,i0)
...
!  i0 ( h1 h2 h3 h4 )_yt + = +1/6 * Sum ( h5 p6 p7 p8 ) * y ( h1 h2 h5 p6 p7 p8 )_y * t ( p6 p7 p8 h3 h4 h5 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:nact,1:nact,1:nact,1:nact)
  integer(c_int) :: h1,h2,h3,h4
  integer(c_int) :: h5,p6,p7,p8,sh5,sp6,sp7,sp8
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
...
end subroutine bccdt_den2p_13
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_14(sp1,sp2,sp3,sh4,i0)
...
end subroutine bccdt_den2p_14
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_15(sh1,sp2,sh3,sh4,i0)
...
end subroutine bccdt_den2p_15
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_16(sp1,sp2,sp3,sh4,i0)
...
!  i0 ( p1 p2 p3 h4 )_ytt + = -1/4 * Sum ( h5 h6 ) * i1 ( h5 h6 p3 h4 )_yt * t ( p1 p2 h5 h6 )_t 1
  ...
  do sh6 = 1,2
     ...
     call bccdt_den2p_16_1(sh5,sh6,sp3,sh4,itm_hhph)
  ...
  deallocate(itm_hhph)
end subroutine bccdt_den2p_16
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_16_1(sh5,sh6,sp3,sh4,i1)
...
!      i1 ( h5 h6 p3 h4 )_yt + = +1 * Sum ( h7 p8 p9 ) * y ( h5 h6 h7 p3 p8 p9 )_y * t ( p8 p9 h4 h7 )_t 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh5,sh6,sp3,sh4
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,(norb1+1):nact,1:norb1)
  integer(c_int) :: h5,h6,p3,h4
  integer(c_int) :: h7,p8,p9,sh7,sp8,sp9
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t2inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
end subroutine bccdt_den2p_16_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_17(sh1,sp2,sh3,sh4,i0)
...
!  i0 ( h1 p2 h3 h4 )_ytt + = +1/4 * Sum ( p5 p6 ) * i1 ( h1 p5 p6 p2 )_yt * t ( p5 p6 h3 h4 )_t 1
  ...
  do sp6 = 1,2
     ...
     call bccdt_den2p_17_1(sh1,sp5,sp6,sp2,itm_hppp)
  ...
  deallocate(itm_hppp)
end subroutine bccdt_den2p_17
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_17_1(sh1,sp5,sp6,sp2,i1)
...
!      i1 ( h1 p5 p6 p2 )_yt + = +1 * Sum ( h7 h8 p9 ) * y ( h1 h7 h8 p5 p6 p9 )_y * t ( p2 p9 h7 h8 )_t 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh1,sp5,sp6,sp2
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h1,p5,p6,p2
  integer(c_int) :: h7,h8,p9,sh7,sh8,sp9
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t2inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
end subroutine bccdt_den2p_17_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_18(sp1,sp2,sp3,sh4,i0)
...
!  i0 ( p1 p2 p3 h4 )_ytt + = +1/2 * P( p1 p2 ) * Sum ( h5 p6 ) * i1 ( h5 p3 p6 p1 )_yt * t ( p2 p6 h4 h5 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_18_perm(sp1,sp2,sp3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sp3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_18_perm(sp2,sp1,sp3,sh4,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_18_perm(sp1,sp2,sp3,sh4,i0)
  ...
  do sp6 = 1,2
     ...
     itm_hppp(1:norb1,(norb1+1):nact,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_den2p_18_1(sh5,sp3,sp6,sp1,itm_hppp)
  ...
  deallocate(itm_hppp)
  end subroutine bccdt_den2p_18_perm
  !--------------------------------------------
end subroutine bccdt_den2p_18
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_18_1(sh5,sp3,sp6,sp1,i1)
...
!      i1 ( h5 p3 p6 p1 )_yt + = +1 * Sum ( h7 h8 p9 ) * y ( h7 h8 h5 p9 p3 p6 )_y * t ( p9 p1 h7 h8 )_t 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh5,sp3,sp6,sp1
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h5,p3,p6,p1
  integer(c_int) :: h7,h8,p9,sh7,sh8,sp9
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t2inp_2
  integer(c_int),external :: tdcc_spin_g3inp
...
end subroutine bccdt_den2p_18_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_19(sh1,sp2,sh3,sh4,i0)
...
!  i0 ( h1 p2 h3 h4 )_ytt + = -1/2 * P( h3 h4 ) * Sum ( h5 p6 ) * i1 ( h1 h5 p6 h3 )_yt * t ( p2 p6 h4 h5 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_19_perm(sh1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do h1 = 1,norb1
  ...
  if(.not. (sh1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_19_perm(sh1,sp2,sh4,sh3,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_19_perm(sh1,sp2,sh3,sh4,i0)
  ...
  do sp6 = 1,2
     ...
     itm_hhph(1:norb1,1:norb1,(norb1+1):nact,1:norb1) = czero
     call bccdt_den2p_19_1(sh1,sh5,sp6,sh3,itm_hhph)
  ...
  deallocate(itm_hhph)
  end subroutine bccdt_den2p_19_perm
  !--------------------------------------------
end subroutine bccdt_den2p_19
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_19_1(sh1,sh5,sp6,sh3,i1)
...
end subroutine bccdt_den2p_19_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_20(sp1,sh2,sp3,sp4,i0)
...
end subroutine bccdt_den2p_20
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_21(sh1,sh2,sh3,sp4,i0)
...
end subroutine bccdt_den2p_21
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_22(sp1,sp2,sh3,sh4,i0)

!  i0 ( p1 p2 h3 h4 )_yt + = +1 * Sum ( h5 p6 ) * y ( h5 p6 )_y * t ( p1 p2 p6 h3 h4 h5 )_t 0
  ...
  do sp6 = 1,2
     ...
     spin_t3inp_2 = tdcc_spin_t3inp(sp1,sp2,sp6,sh3,sh4,sh5)
     if(spin_g1inp_1 * spin_t3inp_2 == 0) cycle
     ...
     do p6 = norb1+1,nact
        i0(p1,p2,h3,h4) = i0(p1,p2,h3,h4) + fact * &
             g1inp(h5,p6,spin_g1inp_1) * t3inp(p1,p2,p6,h3,h4,h5,spin_t3inp_2)
     end do
     end do
     end do
     end do
...
end subroutine bccdt_den2p_22
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_23(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = +1/4 * P( h3 h4 ) * P( p1 p2 ) * Sum ( h5 p6 ) * i1 ( h5 p6 p1 h3 )_yt * t ( p2 p6 h4 h5 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_23_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_23_perm(sp1,sp2,sh4,sh3,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_23_perm(sp2,sp1,sh3,sh4,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_23_perm(sp2,sp1,sh4,sh3,i0_perm)
  end if
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_23_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sp6 = 1,2
     ...
     itm_hpph(1:norb1,(norb1+1):nact,(norb1+1):nact,1:norb1) = czero
     call bccdt_den2p_23_1(sh5,sp6,sp1,sh3,itm_hpph)
  ...
  deallocate(itm_hpph)
  end subroutine bccdt_den2p_23_perm
  !--------------------------------------------
end subroutine bccdt_den2p_23
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_23_1(sh5,sp6,sp1,sh3,i1)
...
!      i1 ( h5 p6 p1 h3 )_yt + = +1 * Sum ( h7 h8 p9 p10 ) * y ( h7 h8 h5 p9 p10 p6 )_y * t ( p9 p10 p1 h7 h8 h3 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,(norb1+1):nact,1:norb1)
  integer(c_int) :: h5,p6,p1,h3
  integer(c_int) :: h7,h8,p9,p10,sh7,sh8,sp9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
...
end subroutine bccdt_den2p_23_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_24(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = +1/12 * Sum ( p5 p6 ) * i1 ( p5 p6 p1 p2 )_yt * t ( p5 p6 h3 h4 )_t 1
  ...
  do sp6 = 1,2
     ...
     call bccdt_den2p_24_1(sp5,sp6,sp1,sp2,itm_pppp)
  ...
  deallocate(itm_pppp)
end subroutine bccdt_den2p_24
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_24_1(sp5,sp6,sp1,sp2,i1)
...
!      i1 ( p5 p6 p1 p2 )_yt + = +1 * Sum ( h7 h8 h9 p10 ) * y ( h7 h8 h9 p10 p5 p6 )_y * t ( p10 p1 p2 h7 h8 h9 )_t 0
  ...
  implicit none
  integer(c_int),intent(in) :: sp5,sp6,sp1,sp2
  complex(kind(0d0)),intent(inout) :: i1((norb1+1):nact,(norb1+1):nact,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: p5,p6,p1,p2
  integer(c_int) :: h7,h8,h9,p10,sh7,sh8,sh9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
...
end subroutine bccdt_den2p_24_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_25(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = +1/12 * Sum ( h5 h6 ) * i1 ( h5 h6 h3 h4 )_yt * t ( p1 p2 h5 h6 )_t 1
  ...
  do sh6 = 1,2
     ...
     itm_hhhh(1:norb1,1:norb1,1:norb1,1:norb1) = czero
     call bccdt_den2p_25_1(sh5,sh6,sh3,sh4,itm_hhhh)
  ...
  deallocate(itm_hhhh)
end subroutine bccdt_den2p_25
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_25_1(sh5,sh6,sh3,sh4,i1)
...
!      i1 ( h5 h6 h3 h4 )_yt + = +1 * Sum ( h7 p8 p9 p10 ) * y ( h7 h5 h6 p8 p9 p10 )_y * t ( p8 p9 p10 h7 h3 h4 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,1:norb1,1:norb1)
  integer(c_int) :: h5,h6,h3,h4
  integer(c_int) :: h7,p8,p9,p10,sh7,sp8,sp9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
...
end subroutine bccdt_den2p_25_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_26(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = -1/12 * P( h3 h4 ) * Sum ( h5 ) * i1 ( h5 h3 )_yt * t ( p1 p2 h5 h4 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_26_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_26_perm(sp1,sp2,sh4,sh3,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_26_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sh5 = 1,2
     ...
     itm_hh(1:norb1,1:norb1) = czero
     call bccdt_den2p_26_1(sh5,sh3,itm_hh)
  ...
  deallocate(itm_hh)
  end subroutine bccdt_den2p_26_perm
  !--------------------------------------------
end subroutine bccdt_den2p_26
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_26_1(sh5,sh3,i1)
...
!      i1 ( h5 h3 )_yt + = +1 * Sum ( h6 h7 p8 p9 p10 ) * y ( h6 h7 h5 p8 p9 p10 )_y * t ( p8 p9 p10 h6 h7 h3 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1)
  integer(c_int) :: h5,h3
  integer(c_int) :: h6,h7,p8,p9,p10,sh6,sh7,sp8,sp9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
...
end subroutine bccdt_den2p_26_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_27(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = -1/12 * P( p1 p2 ) * Sum ( p5 ) * i1 ( p5 p1 )_yt * t ( p5 p2 h3 h4 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_27_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_27_perm(sp2,sp1,sh3,sh4,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_27_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sp5 = 1,2
     ...
     itm_pp((norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_den2p_27_1(sp5,sp1,itm_pp)
  ...
  deallocate(itm_pp)
  end subroutine bccdt_den2p_27_perm
  !--------------------------------------------
end subroutine bccdt_den2p_27
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_27_1(sp5,sp1,i1)
...
!      i1 ( p5 p1 )_yt + = +1 * Sum ( h6 h7 h8 p9 p10 ) * y ( h6 h7 h8 p9 p10 p5 )_y * t ( p9 p10 p1 h6 h7 h8 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i1((norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: p5,p1
  integer(c_int) :: h6,h7,h8,p9,p10,sh6,sh7,sh8,sp9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
...
end subroutine bccdt_den2p_27_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_28(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = -1/4 * P( h3 h4 ) * Sum ( h5 h6 p7 ) * i1 ( h5 h6 p7 h3 )_yt * t ( p1 p2 p7 h5 h4 h6 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_28_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_28_perm(sp1,sp2,sh4,sh3,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_28_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sp7 = 1,2
     ...
     itm_hhph(1:norb1,1:norb1,(norb1+1):nact,1:norb1) = czero
     call bccdt_den2p_28_1(sh5,sh6,sp7,sh3,itm_hhph)
  ...
  deallocate(itm_hhph)
  end subroutine bccdt_den2p_28_perm
  !--------------------------------------------
end subroutine bccdt_den2p_28
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_28_1(sh5,sh6,sp7,sh3,i1)
...
!      i1 ( h5 h6 p7 h3 )_yt + = +1 * Sum ( h8 p9 p10 ) * y ( h8 h5 h6 p9 p10 p7 )_y * t ( p9 p10 h8 h3 )_t 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh5,sh6,sp7,sh3
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,(norb1+1):nact,1:norb1)
  integer(c_int) :: h5,h6,p7,h3
  integer(c_int) :: h8,p9,p10,sh8,sp9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t2inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
end subroutine bccdt_den2p_28_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_29(sp1,sp2,sh3,sh4,i0)
...
!  i0 ( p1 p2 h3 h4 )_ytt + = -1/4 * P( p1 p2 ) * Sum ( h5 p6 p7 ) * i1 ( h5 p6 p7 p1 )_yt * t ( p6 p2 p7 h3 h4 h5 )_t 1
  ...
  i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
  call bccdt_den2p_29_perm(sp1,sp2,sh3,sh4,i0_perm)
  fact_p = +1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  do p1 = norb1+1,nact
  ...
  if(.not. (sp1 * sp2 * sh3 * sh4 == 1)) then
     i0_perm(1:nact,1:nact,1:nact,1:nact) = czero
     call bccdt_den2p_29_perm(sp2,sp1,sh3,sh4,i0_perm)
  end if
  fact_p = -1.0d+0
  !$omp parallel default(shared)
  !$omp do collapse(4)
  ...
  contains
  !--------------------------------------------
  subroutine bccdt_den2p_29_perm(sp1,sp2,sh3,sh4,i0)
  ...
  do sp7 = 1,2
     ...
     itm_hppp(1:norb1,(norb1+1):nact,(norb1+1):nact,(norb1+1):nact) = czero
     call bccdt_den2p_29_1(sh5,sp6,sp7,sp1,itm_hppp)
  ...
  deallocate(itm_hppp)
  end subroutine bccdt_den2p_29_perm
  !--------------------------------------------
end subroutine bccdt_den2p_29
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_29_1(sh5,sp6,sp7,sp1,i1)
...
!      i1 ( h5 p6 p7 p1 )_yt + = +1 * Sum ( h8 h9 p10 ) * y ( h8 h9 h5 p10 p6 p7 )_y * t ( p10 p1 h8 h9 )_t 0
  ...
  integer(c_int) :: h8,h9,p10,sh8,sh9,sp10
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t2inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
end subroutine bccdt_den2p_29_1
!##########################################################
!##########################################################
!##########################################################
!##########################################################
subroutine bccdt_den2p_30(sh1,sp2,sp3,sh4,i0)
...
!  i0 ( h1 p2 p3 h4 )_yt + = +1/4 * Sum ( h5 h6 p7 p8 ) * y ( h5 h6 h1 p7 p8 p3 )_y * t ( p7 p8 p2 h5 h6 h4 )_t 0
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:nact,1:nact,1:nact,1:nact)
  integer(c_int) :: h1,p2,p3,h4
  integer(c_int) :: h5,h6,p7,p8,sh5,sh6,sp7,sp8
  integer(c_int) :: spin_g3inp_1
  integer(c_int) :: spin_t3inp_2
  integer(c_int),external :: tdcc_spin_g3inp
  integer(c_int),external :: tdcc_spin_t3inp
