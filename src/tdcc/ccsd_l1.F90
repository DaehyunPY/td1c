...
! i0 ( h2 p1 )_yv + = -1/2 * Sum ( h11 h12 p9 ) * y ( h11 h12 p1 p9 )_y * i1 ( h2 p9 h11 h12 )_v 6
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:norb1,(norb1+1):nact)
  integer :: h2,p1
  integer :: h11,h12,p9,sh11,sh12,sp9
  integer :: spin_g2inp
...
!         i2 ( h5 h6 h10 p3 )_yt + = -1 * Sum ( p7 ) * t ( p7 h10 )_t * y ( h5 h6 p3 p7 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh5,sh6,sh10,sp3
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer :: h5,h6,h10,p3
  integer :: p7,sp7
  integer :: spin_t1inp
  integer :: spin_g2inp
  integer,external :: tdcc_spin_t1inp
...
!     i1 ( h2 h6 h4 p5 )_yt + = 1 * Sum ( p3 ) * t ( p3 h4 )_t * y ( h2 h6 p3 p5 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh6,sh4,sp5
...
! i0 ( h2 p1 )_ytv + = 1/2 * Sum ( p9 h12 h6 ) * i1 ( h2 p9 h6 h12 )_yt * v ( h6 h12 p1 p9 )_v 4
  ...
  complex(kind(0d0)),intent(inout) :: i0(1:norb1,(norb1+1):nact)
  integer :: h2,p1
  integer :: p9,h12,h6,sp9,sh12,sh6
  integer :: spin_itm_hphh
  integer :: spin_int2x
  integer,external :: tdcc_spin_dummy2
  integer,external :: tdcc_spin_int2x
...
!     i1 ( h2 p9 h6 h12 )_yt + = -1 * Sum ( p3 ) * t ( p3 p9 h6 h12 )_t * y ( h2 p3 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sp9,sh6,sh12
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,1:norb1,1:norb1)
  integer :: h2,p9,h6,h12
  integer :: p3,sp3
  integer :: spin_t2inp
  integer :: spin_g1inp
  integer,external :: tdcc_spin_t2inp
...
!         i2 ( h2 h10 h6 h12 )_yt + = 1 * Sum ( p3 p4 ) * t ( p3 p4 h6 h12 )_t * y ( h2 h10 p3 p4 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh10,sh6,sh12
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,1:norb1)
  integer :: h2,h10,h6,h12
  integer :: p3,p4,sp3,sp4
  integer :: spin_t2inp
  integer :: spin_g2inp
  integer,external :: tdcc_spin_t2inp
...
!             i3 ( h2 h10 h6 p5 )_yt + = 1 * Sum ( p7 ) * t ( p7 h6 )_t * y ( h2 h10 p5 p7 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh10,sh6,sp5
  complex(kind(0d0)),intent(inout) :: i3(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer :: h2,h10,h6,p5
  integer :: p7,sp7
  integer :: spin_t1inp
  integer :: spin_g2inp
  integer,external :: tdcc_spin_t1inp
...
!         i2 ( h2 h5 h6 p3 )_yt + = 1 * Sum ( p7 ) * t ( p7 h6 )_t * y ( h2 h5 p3 p7 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh5,sh6,sp3
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer :: h2,h5,h6,p3
  integer :: p7,sp7
  integer :: spin_t1inp
...
!     i1 ( h2 h7 h6 h8 )_yt + = 1 * Sum ( p3 p4 ) * t ( p3 p4 h6 h8 )_t * y ( h2 h7 p3 p4 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh7,sh6,sh8
...
!         i2 ( h2 h7 h6 p3 )_yt + = 1 * Sum ( p5 ) * t ( p5 h6 )_t * y ( h2 h7 p3 p5 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh7,sh6,sp3
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer :: h2,h7,h6,p3
  integer :: p5,sp5
  integer :: spin_t1inp
...
!     i1 ( h2 p8 h6 p7 )_yt + = 1 * Sum ( h5 p3 ) * t ( p3 p8 h5 h6 )_t * y ( h2 h5 p3 p7 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sp8,sh6,sp7
...
!         i2 ( h2 h4 h6 p7 )_yt + = 1 * Sum ( p5 ) * t ( p5 h6 )_t * y ( h2 h4 p5 p7 )_y 0
  ...
  implicit none
  integer,intent(in) :: sh2,sh4,sh6,sp7
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer :: h2,h4,h6,p7
  integer :: p5,sp5
  integer :: spin_t1inp
