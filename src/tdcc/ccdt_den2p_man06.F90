!##########################################################
subroutine ccdt_den2p_man06(i0ab,i0ba,work1,work2,work3)

!  i0 ( a b i j )_ytt + = P( a b ) * Sum ( c ) * i1 ( a c )_yt * t ( c b i j )_t 1
...
end subroutine ccdt_den2p_man06
!##########################################################
subroutine ccdt_den2p_man06_1(i1)

! i1 ( a b )_yt + = -1/2 * Sum ( i j c ) * y ( i j c b )_y * t ( c a i j )_t 0
...
end subroutine ccdt_den2p_man06_1
!##########################################################
