!**********************************************************
subroutine ccdt_bmat2p_main(den)
...
!debug
!write(6,"('ccdt_bmat2p_main: skip b2.')")
!return
!debug

  if (cc_code(1:4) == 'auto') then
     call ccdt_bmat2p_1(1,1,den)
     call ccdt_bmat2p_2(1,1,den)
     call ccdt_bmat2p_3(1,1,den)
  else
...
end subroutine ccdt_bmat2p_main
!**********************************************************
