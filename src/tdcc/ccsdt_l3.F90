...
!         i2 ( h4 p7 )_f + = 1 * f ( h4 p7 )_f 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sp7
...
!         i2 ( h8 p1 )_vt + = 1 * Sum ( h10 p9 ) * t ( p9 h10 )_t * v ( h8 h10 p1 p9 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh8,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,(norb1+1):nact)
  integer(c_int) :: h8,p1
  integer(c_int) :: h10,p9,sh10,sp9
  integer(c_int) :: spin_t1inp
...
!         i2 ( h4 h10 h12 p1 )_vt + = 1 * Sum ( p7 ) * t ( p7 h12 )_t * v ( h4 h10 p1 p7 )_v 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sh10,sh12,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h4,h10,h12,p1
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_int2x
  integer(c_int),external :: tdcc_spin_t1inp
...
!     i1 ( h4 h5 h6 h7 p1 p2 )_yt + = 1 * Sum ( p8 ) * t ( p8 h7 )_t * y ( h4 h5 h6 p1 p2 p8 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sh5,sh6,sh7,sp1,sp2
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h4,h5,h6,h7,p1,p2
...
!     i1 ( h4 h5 h9 h8 p1 p2 )_yt + = 1 * Sum ( p7 ) * t ( p7 h8 )_t * y ( h4 h5 h9 p1 p2 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sh5,sh9,sh8,sp1,sp2
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h4,h5,h9,h8,p1,p2
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!     i1 ( h4 h5 h6 h8 p1 p9 )_yt + = -1 * Sum ( p7 ) * t ( p7 h8 )_t * y ( h4 h5 h6 p1 p7 p9 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sh5,sh6,sh8,sp1,sp9
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h4,h5,h6,h8,p1,p9
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
...
! i0 ( h4 h5 h6 p1 p2 p3 )_ytv + = -1/4 * P( 3 ) * Sum ( h11 h10 ) * i1 ( h4 h5 h6 h10 h11 p1 )_yt * v ( h10 h11 p2 p3 )_v 2
  ...
  integer(c_int) :: h4,h5,h6,p1,p2,p3
  integer(c_int) :: h11,h10,sh11,sh10
...
!     i1 ( h4 h5 h6 h10 h11 p1 )_yt + = -1 * Sum ( p7 p8 ) * t ( p7 p8 h10 h11 )_t * y ( h4 h5 h6 p1 p7 p8 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sh5,sh6,sh10,sh11,sp1
  complex(kind(0d0)),intent(inout) :: &
       i1(1:norb1,1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h4,h5,h6,h10,h11,p1
  integer(c_int) :: p7,p8,sp7,sp8
  integer(c_int) :: spin_t2inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t2inp
...
!         i2 ( h4 h5 h6 h10 p1 p7 )_yt + = -1 * Sum ( p9 ) * t ( p9 h10 )_t * y ( h4 h5 h6 p1 p7 p9 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh4,sh5,sh6,sh10,sp1,sp7
  complex(kind(0d0)),intent(inout) :: &
       i2(1:norb1,1:norb1,1:norb1,1:norb1,(norb1+1):nact,(norb1+1):nact)
  integer(c_int) :: h4,h5,h6,h10,p1,p7
  integer(c_int) :: p9,sp9
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g3inp
  integer(c_int),external :: tdcc_spin_t1inp
