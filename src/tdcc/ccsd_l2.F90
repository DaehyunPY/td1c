...
!     i1 ( h3 h7 h6 p1 )_yt + = 1 * Sum ( p5 ) * t ( p5 h6 )_t * y ( h3 h7 p1 p5 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh7,sh6,sp1
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h7,h6,p1
  integer(c_int) :: p5,sp5
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!     i1 ( h3 h4 h6 p7 )_yt + = -1 * Sum ( p5 ) * t ( p5 h6 )_t * y ( h3 h4 p5 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh6,sp7
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h6,p7
  integer(c_int) :: p5,sp5
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h4 h8 p5 )_yt + = -1 * Sum ( p7 ) * t ( p7 h8 )_t * y ( h3 h4 p5 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh4,sh8,sp5
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h4,h8,p5
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t1inp
...
!     i1 ( h3 p5 h8 p1 )_ytt + = 1 * Sum ( h6 ) * t ( p5 h6 )_t * i2 ( h3 h6 h8 p1 )_yt 1
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sp5,sh8,sp1
  complex(kind(0d0)),intent(inout) :: i1(1:norb1,(norb1+1):nact,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,p5,h8,p1
  integer(c_int) :: h6,sh6
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_itm_hhhp
  integer(c_int),external :: tdcc_spin_t1inp
...
!         i2 ( h3 h6 h8 p1 )_yt + = 1 * Sum ( p7 ) * t ( p7 h8 )_t * y ( h3 h6 p1 p7 )_y 0
  ...
  implicit none
  integer(c_int),intent(in) :: sh3,sh6,sh8,sp1
  complex(kind(0d0)),intent(inout) :: i2(1:norb1,1:norb1,1:norb1,(norb1+1):nact)
  integer(c_int) :: h3,h6,h8,p1
  integer(c_int) :: p7,sp7
  integer(c_int) :: spin_t1inp
  integer(c_int) :: spin_g2inp
  integer(c_int),external :: tdcc_spin_t1inp
