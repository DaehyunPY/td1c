!##########################################################
subroutine ccdt_den2xp_man01(i0,work1,work2)

! i0 ( a b i j )_ytt + = -1/2 * Sum ( c ) 
!  * i1 ( c b )_yt * t ( a c i j )_t 1
  ...
  work1 = 0d0
  call ccdt_den2xp_man01_1(work1)
...
end subroutine ccdt_den2xp_man01
!##########################################################
subroutine ccdt_den2xp_man01_1(i1)
...
end subroutine ccdt_den2xp_man01_1
!##########################################################
