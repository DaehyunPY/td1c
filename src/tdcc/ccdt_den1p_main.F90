!**********************************************************
subroutine ccdt_den1p_main(den)
...
!debug
  ...
  if (cc_code(1:4) == 'auto') then
     call ccdt_den1p_1(1,1,den)
     call ccdt_den1p_2(1,1,den)
     call ccdt_den1p_3(1,1,den)
     call ccdt_den1p_4(1,1,den)
     call ccdt_den1p_5(1,1,den)
     call ccdt_den1p_6(1,1,den)
  else
...
end subroutine ccdt_den1p_main
!**********************************************************
