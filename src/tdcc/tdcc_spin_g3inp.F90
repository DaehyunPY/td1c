!###################################################################################
integer function tdcc_spin_g3inp(sh1, sh2, sh3, sp4, sp5, sp6)
...
!  0 : others
  ...
  implicit none
  integer, intent(in) :: sh1,sh2,sh3, sp4,sp5,sp6
  integer :: spin_type
  ...
  tdcc_spin_g3inp = spin_type

end function tdcc_spin_g3inp
!###################################################################################
