...
subroutine hprod_set_wfn0(wfn, cic, v2xfc_type)
  ...
  use mod_control, only : xfc_implicit
...
!bug_for_read v2xfc(1:(nrad-1)) = czero ! Local-X of FC2
  ...
  v2_type = 'fcfc'
  call hprod_mkrho2p(v2_type, orbg, v2ang)        ! FC-FC pair density, ang
  call bas_ang2sph2_fcfc(v2ang, rho2);            ! FC-FC pair density, sph
  call hprod_mkv2mf_poisson(v2_type, rho2, v2sph) ! FC-FC pair potential, sph
  call bas_sph2ang2_fcfc(v2sph, v2ang);           ! FC-FC pair potential, ang
  call hprod_mkv2mf_herm(v2_type, v2sph, v2ang)   ! Hermitialization

!  if (nfcore1 > 0) then
!     v2_type = 'fc1fc1'
!     call hprod_mkrho2p(v2_type, orbg, v2ang)        ! FC1-FC1 pair density, ang
!     call bas_ang2sph2_fc1fc1(v2ang, rho2);          ! FC1-FC1 pair density, sph
!     call hprod_mkv2mf_poisson(v2_type, rho2, v2sph) ! FC1-FC1 pair potential, sph
...
subroutine hprod_v2xfc_opt1(orbg, v2xfc)
  ...
  v2_type = 'fc2dyn'
  call hprod_mkrho2p(v2_type, orbg, v2ang)
  call bas_ang2sph2_fc2dyn(v2ang, rho2);
  call hprod_mkv2mf_poisson(v2_type, rho2, v2sph)
  call bas_sph2ang2_fc2dyn(v2sph, v2ang);
  call hprod_mkv2mf_herm(v2_type, v2sph, v2ang)
...
subroutine hprod_v2fc_enefc(enefc)
  ...
  use mod_hprod, only : orb, h0orb, gorb, gorbg
