!################################################################################
subroutine util_gdiag(dsc, n, a, uleft, uright)
...
!debug  complex(c_double_complex) :: norm
!debug  complex(c_double_complex) :: sij
!debug  complex(c_double_complex), external :: util_zdotc, util_zdotu
...
!debug        uright(1:n, i) = vecr(1:n, j) / norm
  ...
  ! write(6, "('gdiag: biorthogonality check')")
  do i = 1, n
     do j = 1, n
        test = (0.d+0, 0.d+0)
        do k = 1, n
