...
////////////////////////////////////////////////////////////////////////
cllawmul::cllawmul(const clmpi& MPIP, const clio& IO, const clbas& Bas,
		 const clfield& Field, const clhprod& HPW)
{
  gen(MPIP, IO, Bas, Field, HPW);
}
////////////////////////////////////////////////////////////////////////
void cllawmul::gen(const clmpi& MPIP, const clio& IO, const clbas& Bas,
		  const clfield& Field, const clhprod& HPW)
{
  ...
  if (lawrk_npade != 11 &&
      lawrk_npade != 12 &&
      lawrk_npade != 22) {
    std::cout << "cllawmul::gen: bad lawrk_npade." << std::endl;
    abort();
  }
  if (lawrk_order != 1 &&
      lawrk_order != 2 &&
      lawrk_order != 3 &&
      lawrk_order != 4) {
    std::cout << "cllawmul::gen: bad lawrk_order." << std::endl;
    abort();
  }
...
//DEBUG
//  std::cout << "abort for debug @ cllawmul::gen." << std::endl;
//  abort();
//DEBUG
}
////////////////////////////////////////////////////////////////////////
void cllawmul::prop(const clmpi& Proc, const clbas& Bas, 
...
////////////////////////////////////////////////////////////////////////
void cllawmul::prop(const clmpi& Proc, const clbas& Bas, const clfield& Field,
...
////////////////////////////////////////////////////////////////////////
void cllawmul::prop1(const clmpi& Proc, const clbas& Bas,
		    const clfield& Field, clhprod& HPW, clwfn& Wfn)
{
  double lfield[9];
...
////////////////////////////////////////////////////////////////////////
void cllawmul::prop2(const clmpi& Proc, const clbas& Bas,
		    const clfield& Field, clhprod& HPW, clwfn& Wfn)
{
  double lfield[9];
...
////////////////////////////////////////////////////////////////////////
void cllawmul::prop3(const clmpi& Proc, const clbas& Bas,
		    const clfield& Field, clhprod& HPW, clwfn& Wfn)
{
  double lfield[9];
  dcomplex cdt1  = Field.dtime;
...
////////////////////////////////////////////////////////////////////////
void cllawmul::prop4(const clmpi& Proc, const clbas& Bas,
		    const clfield& Field, clhprod& HPW, clwfn& Wfn)
{
  double lfield[9];
  dcomplex cdt1 = Field.dtime;
...
////////////////////////////////////////////////////////////////////////
//oldvoid cllawmul::prop4_old(const clmpi& Proc, const clbas& Bas,
...
//old}
////////////////////////////////////////////////////////////////////////
void cllawmul::expwfn(const clmpi& Proc, const clbas& Bas, const clfield& Field, 
...
////////////////////////////////////////////////////////////////////////
void cllawmul::expwfn11(const clmpi& Proc, const clbas& Bas, const clfield& Field, 
		       clhprod& HPW, const clwfn& Wfn, clwfn& ExpWfn)
{
...
//old    HPW.copyo(Proc, Bas, Wfn, ExpWfn);
    ...
    std::cout << "cllawmul::expwfn11: only midpt" << std::endl;
    abort();
    ...
    //*****
    std::cout << "cllawmul::expwfn11. h1tot DOES NOT multiply dt factor!" << std::endl;
    abort();
...
////////////////////////////////////////////////////////////////////////
void cllawmul::expwfn12(const clmpi& Proc, const clbas& Bas, const clfield& Field,
		       clhprod& HPW, const clwfn& Wfn, clwfn& ExpWfn)
{
  std::cout << "cllawmul::expwfn12 nyi." << std::endl;
  abort();
...
////////////////////////////////////////////////////////////////////////
void cllawmul::expwfn22(const clmpi& Proc, const clbas& Bas, const clfield& Field, 
		       clhprod& HPW, const clwfn& Wfn, clwfn& ExpWfn)
{
  std::cout << "cllawmul::expwfn22 nyi." << std::endl;
  abort();
