!################################################################################
subroutine ormas_mkidm_old(ovlp, cic, dens)
  ...
  !debug
!  write(6, "('ormas_mkidm_old: Ovlp-R')")
!  do ifun = 1, nfun
!     do jfun = 1, nfun
...
!     write(6, *)
!  end do
!  write(6, "('ormas_mkidm_old: Ovlp-I')")
!  do ifun = 1, nfun
!     do jfun = 1, nfun
...
end subroutine ormas_mkidm_old
!################################################################################
